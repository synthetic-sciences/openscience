...
import type {
  ...
  HarnessWorldRefineErrors,
  HarnessWorldRefineResponses,
  HarnessWorldStatusErrors,
  HarnessWorldStatusResponses,
...
export class World extends HeyApiClient {
  /**
   * Read the session-local continual world model
   *
  ...
  public status<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<HarnessWorldStatusResponses, HarnessWorldStatusErrors, ThrowOnError>({
      url: "/harness/runs/{sessionID}/world",
      ...options,
      ...params,
    })
  }
  ...
  /**
   * Apply an evaluator-authenticated world-model refinement
   *
   ...
   */
  public refine<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      evaluatorToken?: string
      expectedRevision?: number
      reason?: "manual" | "failure" | "stagnation" | "milestone" | "periodic"
      patches?: Array<
        | {
            op: "upsert"
            key: string
            kind: "hypothesis" | "observation" | "strategy" | "memory" | "skill" | "subagent"
            content: string
            confidence: number
            evidenceRefs?: Array<string>
          }
    ...
    return (options?.client ?? this.client).post<HarnessWorldRefineResponses, HarnessWorldRefineErrors, ThrowOnError>({
      url: "/harness/runs/{sessionID}/world/refinements",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Harness extends HeyApiClient {
  /**
   * Bind an immutable scientific evaluation run
   *
  ...
  public bind<ThrowOnError extends boolean = false>(
    parameters?: {
      ...
      benchmark?: string
      title?: string
      family?: "data" | "biology" | "physics" | "chemistry" | "ml" | "generalist" | "custom"
      task?: string
      version?: string
      taskID?: string
  ...
  /**
   * Compare compatible scientific evaluation runs
   *
  ...
  /**
   * Build an evaluation quality-cost report
   */
  ...
  get world(): World {
    return (this._world ??= new World({ client: this.client }))
  }
