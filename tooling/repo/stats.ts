...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/synthetic-sciences/OpenScience/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for synthetic-sciences/OpenScience...\n")
...
console.log("Fetching npm all-time downloads for openscience-ai...\n")
const npmDownloads = await fetchNpmDownloads("openscience-ai")
