...
const library = [
  ...
  "OpenScience includes " +
    total +
    " skill files in this version. This directory is generated from the bundled library. Names link to their instructions and supporting files on GitHub.",
  "",
...
console.log(
  check
    ...
    : "Generated " + total + " skills and " + registry.catalog().length + " database entries.",
)
