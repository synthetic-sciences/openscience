...
import { IconOpenScience } from "./icons/custom"
import styles from "./share.module.css"
import type { MessageV2 } from "@synsci/openscience/session/message-v2"
import type { Message } from "@synsci/openscience/session/message"
import type { Session } from "@synsci/openscience/session/index"
...
export default function Share(props: { id: string; api: string; info: Session.Info }) {
  ...
  const messages = createMemo(() => [...Object.values(store.messages)].sort((a, b) => a.id?.localeCompare(b.id)))
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="openscience version" data-slot="item">
                <div data-slot="icon" title="openscience">
                  <IconOpenScience width={16} height={16} />
                </div>
