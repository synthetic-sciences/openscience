...
OpenScience's share feature lets you create public links to your OpenScience conversations, so you can collaborate with teammates or get help from others.
...
By default, OpenScience uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `openscience.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using openscience in your organization.
