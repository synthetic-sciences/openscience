...
Enabled and fail-closed by default. Routine contained work does not require project trust; project extensions and host execution do. See [Sandbox and project trust](/openscience/sandbox).
