...
Connecting Synthetic Sciences is optional — see [Synthetic Sciences](/openscience/gateway). OpenScience runs fully standalone with your own provider keys, local models, or eligible ChatGPT/Codex access.
