...
export const dict = {
  ...
  "command.steps.toggle.description": "Vis eller skjul utføringssporet for gjeldende melding",
  ...
  "prompt.placeholder.normal": "Beskriv forskningsoppgaven du vil arbeide med…",
