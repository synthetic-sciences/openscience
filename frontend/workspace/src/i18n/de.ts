...
export const dict = {
  ...
  "command.steps.toggle.description": "Ausführungsprotokoll für die aktuelle Nachricht anzeigen oder ausblenden",
  ...
  "prompt.placeholder.normal": "Beschreiben Sie die Forschungsaufgabe, an der Sie arbeiten möchten…",
