...
describe("models and compute settings UI contract", () => {
  test("presents inference routing as one semantic choice group", async () => {
    ...
    for (const description of [
      "Use the credential connected to the selected model route.",
      "Use Synthetic Sciences credits for supported models.",
      "Use only connected provider keys and subscriptions.",
    ]) {
