...
// Build the openscience web UI (frontend/app) and regenerate the embedded asset
...
//
// `frontend/app/package.json` references workspace packages via the `catalog:`
...
const webAppDir = path.resolve(repoRoot, "frontend/app")
...
console.log("building frontend/app (openscience web)")
