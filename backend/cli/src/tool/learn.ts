...
export const LearnTool = Tool.define("learn", {
  description:
    "Quarantine a learned skill proposal distilled from conversation analysis. The proposal stays inactive until independent held-out and trigger evaluations qualify it.",
  parameters: z.object({
