...
export namespace HarnessContract {
  ...
  export const Family = z.enum(["data", "biology", "physics", "chemistry", "ml", "generalist", "custom"])
  ...
  export const Info = z
    .object({
      ...
      benchmark: z
        .object({
          name: z.string().min(1),
          title: z.string().min(1).max(240).default("Scientific evaluation"),
          family: Family.default("custom"),
          task: z.string().min(1).max(4_000).default("Scientific evaluation task"),
