...
export namespace HarnessBenchmark {
  ...
  const recipes = {
    ...
    genebench: "genebench-official-v2",
    ...
    sciagentarena: "sciagentarena-official-v2",
    ainsteinbench: "ainsteinbench-official-v2",
  } as const
  const blockers = {
    posttrain: {
      reason:
    ...
    sciagentarena: item({
      ...
      source: source(
        ...
        [
          ...
          "evaluations/dd/environment.yml",
    ...
    ainsteinbench: item({
      ...
      source: source(
        ...
        [
          ...
          "data/questions/et_converted.jsonl",
          "data/questions/msb_converted.jsonl",
          "data/eval/et_eval.json",
          "data/eval/msb_eval.json",
        ],
      ),
