...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENSCIENCE_CALLER", () => {
    process.env["OPENSCIENCE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENSCIENCE_CALLER", () => {
    process.env["OPENSCIENCE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENSCIENCE_CALLER", () => {
    process.env["OPENSCIENCE_CALLER"] = "unknown"
