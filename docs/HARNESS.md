...
```json
{
  ...
  "formalProof": {
    ...
    "challengeSHA256": "1919191919191919191919191919191919191919191919191919191919191919",
    "statementSHA256": "2020202020202020202020202020202020202020202020202020202020202020",
    "declaration": "Benchmark.target",
    "module": "Benchmark.Proof",
    "leanVersion": "4.33.0",
    "leanToolchainSHA256": "2121212121212121212121212121212121212121212121212121212121212121",
    "lakeManifestSHA256": "2222222222222222222222222222222222222222222222222222222222222222",
    "dependencyTreeSHA256": "2323232323232323232323232323232323232323232323232323232323232323",
    "verifiers": [
      {
        "role": "lean_kernel",
        "name": "lean",
        "version": "4.33.0",
        "artifactSHA256": "2424242424242424242424242424242424242424242424242424242424242424"
      },
      {
        "role": "source_auditor",
        "name": "source-audit",
        "version": "1",
        "artifactSHA256": "2525252525252525252525252525252525252525252525252525252525252525"
      },
      {
        "role": "axiom_auditor",
        "name": "axiom-audit",
        "version": "1",
        "artifactSHA256": "2626262626262626262626262626262626262626262626262626262626262626"
      }
    ],
...
| `verify-formal-proof`          | Freezes Lean challenge, statement, toolchain, dependency and verifier bytes; checks source escapes and transitive axioms; and emits token-free kernel, fresh-replay, or independent-checker evidence.                  |
...
The evaluator submits a canonically ordered complete file manifest plus bound transcripts. The backend rejects `sorry`, `admit`, `debug.skipKernelTC`, and `native_decide` findings, build errors or warnings, incomplete source or axiom audits, axiom inventories that do not traverse axiom types, undeclared axioms including `sorryAx`, substituted verifier artifacts, and tier mismatches. Higher tiers require a fresh `lean4checker --fresh` replay; the strongest tier additionally requires a frozen sandbox, exact trusted-challenge comparison, an exported proof term, and acceptance from both Lean's kernel and an independently implemented checker.

Each run or candidate gets exactly one immutable content-addressed receipt, bound to its artifact and creation interval. A passing final evaluation must postdate and cite a passing receipt. Report comparison, verified memory, learned-skill comparison, and matched ablation all include the full protocol, preventing a low-trust or repaired result from being compared as the same claim. The bundled `verify-formal-proof` skill hashes private files and transcripts into a token-free submission.
...
| [LEAP](https://arxiv.org/abs/2606.03303), [AlphaProof Nexus](https://arxiv.org/abs/2605.22763), and [Goedel-Architect](https://arxiv.org/abs/2606.06468)                                             | Use compiler-guided decomposition, explicit lemma dependency graphs, parallel proof search, and failure-driven blueprint repair, while keeping search architecture separate from result verification. |
| Lean's [Validating a Lean Proof](https://lean-lang.org/doc/reference/latest/ValidatingProofs/) and [issue #8840](https://github.com/leanprover/lean4/issues/8840)                                    | Escalate from kernel builds to fresh replay and an independent checker; audit the full transitive axiom closure including axiom types instead of trusting a textual success marker.                   |
| [Formal Conjectures](https://github.com/google-deepmind/formal-conjectures), [MechGeo](https://arxiv.org/abs/2608.02295), and the [kernel-checked Erdős exclusion](https://arxiv.org/abs/2607.25628) | Freeze Lean/benchmark snapshots, keep exact proof, refutation, and repaired-statement relations distinct, and prohibit unchecked escape hatches from the trusted result path.                         |
