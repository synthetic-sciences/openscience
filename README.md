...
- **One adaptive Research agent.** A single user-facing collaborator handles the task end to end, loads domain skills when useful, and can delegate bounded Explore or Execute work, including explicit biology, physics, and ML specialists. Normal and Ultra efforts control how widely it investigates; plan mode stays read-only.
